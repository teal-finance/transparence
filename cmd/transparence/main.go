...
const WBTC ="3ErNFK17MbH3GAGfakMwTrKo8uHmBuuVX1"
const RENBTC = "19iqYbeATe4RxghQZJnYVFU4mjUUu76EA6"
...
func main() {
	...
	client.ImportAddressRescan(BinanceBTC, "binancebtc", false)
	...
	if err != nil {
		log.Fatal(err, " something something wrong")
	}
