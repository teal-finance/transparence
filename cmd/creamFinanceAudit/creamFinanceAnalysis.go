...
import (
    ...
    "transparence/pkg/TransparenceUtils"
)
...
func displayCompoundTokenInfos(address common.Address, client *ethclient.Client, platform string) {
    ...
    fmt.Printf("\n - CreamFinance stats : TotalBorrows: %2.f %s | Reserve: %2.f ",transparenceutils.ParseDecimals(totalBorrows,decimals), symbol,transparenceutils.ParseDecimals(totalReserve,decimals))
